 ...
 * Fields
 */
$GLOBALS['TL_DCA']['tl_iso_payment']['palettes']['authnet_dpm'] = '{type_legend},name,label,type;{note_legend:hide},note;{config_legend},override_formaction,tableless,new_order_status,allowed_cc_types,requireCCV,minimum_total,maximum_total,countries,shipping_modules,product_types,product_types_condition,config_ids;{gateway_legend},authorize_login,authorize_trans_key,authorize_trans_type,authorize_md5_hash;{price_legend:hide},price,tax_class;{lockout_legend:hide},lockout_attempts,lockout_method,lockout_duration,lockout_message;{expert_legend:hide},guests,protected;{enabled_legend},debug,enabled';
$GLOBALS['TL_DCA']['tl_iso_payment']['palettes']['authnet_aim'] = '{type_legend},name,label,type;{note_legend:hide},note;{config_legend},override_formaction,tableless,new_order_status,allowed_cc_types,requireCCV,minimum_total,maximum_total,countries,shipping_modules,product_types,product_types_condition,config_ids;{gateway_legend},authorize_login,authorize_trans_key,authorize_trans_type;{price_legend:hide},price,tax_class;{lockout_legend:hide},lockout_attempts,lockout_method,lockout_duration,lockout_message;{expert_legend:hide},guests,protected;{enabled_legend},debug,enabled';
$GLOBALS['TL_DCA']['tl_iso_payment']['palettes']['authnet_cim'] = '{type_legend},name,label,type;{note_legend:hide},note;{config_legend},override_formaction,tableless,new_order_status,allowed_cc_types,requireCCV,minimum_total,maximum_total,countries,shipping_modules,product_types,product_types_condition,config_ids;{gateway_legend},authorize_login,authorize_trans_key,authorize_trans_type;{price_legend:hide},price,tax_class;{lockout_legend:hide},lockout_attempts,lockout_method,lockout_duration,lockout_message;{expert_legend:hide},guests,protected;{enabled_legend},debug,enabled';
